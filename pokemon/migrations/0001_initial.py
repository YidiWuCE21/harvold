    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_trainer', models.IntegerField(blank=True, null=True)),
                ...
                ('ability', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('held_item', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Party',
