    ...
    while (pokemonPages[pokemonPages.length - 1].length < rowCount * 6) {
        ...
        React.createElement(
            ...
            React.createElement(
                "div",
                { className: "col-3" },
                React.createElement(PokemonDisplay, { selectedPokemon: selectedPokemon })
            ),
            React.createElement(
                "div",
                { className: "col-6" },
...
function BoxTabs(_ref4) {
    ...
    var _React$useState13 = React.useState(0),
        ...
        currentTab = _React$useState14[0],
        newTab = _React$useState14[1];

    var pokemonTabs = pokemonPages.map(function (page, index) {
        return React.createElement(
            "div",
            { key: "page" + index, style: index == currentTab ? {} : { display: 'none' } },
            React.createElement(BoxPage, { page: page, idx: index, selectedPokemon: selectedPokemon, setSelectedPokemon: setSelectedPokemon })
        );
    });
...
function BoxPage(_ref5) {
    ...
    var pokemonRows = listToMatrix(page, 6).map(function (row, index) {
        return React.createElement(BoxRow, { row: row, key: "row" + index, selectedPokemon: selectedPokemon, setSelectedPokemon: setSelectedPokemon });
    });
...
function BoxCell(_ref7) {
    ...
    if (cell) {
        ...
        var cellRender = React.createElement(
            "div",
            { className: "box-cell select-card".concat(cell["shiny"] ? " shiny" : ""), onClick: function onClick() {
                    return setSelectedPokemon(cell);
                }, style: styling },
            React.createElement(
                "h1",
                null,
